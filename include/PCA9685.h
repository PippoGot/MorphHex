...
// Includes
#include <algorithm>  // library for the min() function

#include "I2C.h"                // custom I2C library
#include "esp_log.h"            // logging library
#include "freertos/freertos.h"  // general purpose library
#include "freertos/task.h"      // delay library
